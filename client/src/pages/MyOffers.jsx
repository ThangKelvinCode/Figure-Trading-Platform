...
//   return (
//     <div className={`trade_request ${offer.offerStatus === "Accepted" ? "accepted" : offer.offerStatus === "Declined" ? "denied" : ""}`}>
//       <div>
//         <h3>Offer for Trade #{tradeRequest._id}</h3>
//         <p>Requesting: {tradeRequest.requestItem}</p>
//         <p>
...
//   const handleCancelOffer = async (offerId, requestId) => {
//     try {
//       // Gọi API cancel-trade đúng theo route đã định nghĩa
...
const OfferBlock = ({ offer, tradeRequest, owner, onCancelOffer, onCompleteTrade }) => {
  ...
  return (
    <div className={`trade_request ${offer.offerStatus === "Accepted" ? "accepted" : offer.offerStatus === "Declined" ? "denied" : isTradeCompleted ? "completed" : ""}`}>
      <div>
        <h3>Offer for Trade #{tradeRequest._id}</h3>
        <p>Requesting: {tradeRequest.requestItem}</p>
        <p>
...
const MyOffers = () => {
  ...
  useEffect(() => {
    ...
    // Polling để tự động làm mới dữ liệu mỗi 5 giây
