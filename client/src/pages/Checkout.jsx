...
//   // const quantityFromQuery = parseInt(queryParams.get("quantity"), 10);
//   // const totalPriceFromQuery = parseInt(queryParams.get("totalPrice"), 10);
...
//         amount: totalPrice,
//         orderId: orderId, // Should be a valid string
//       });
...
//         },
//         data: {
//           orderId: orderId, // Ensure it's a valid string
//           orderDetail,
//         },
//         timeout: 10000,
//       });
...
function Checkout() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await axios({
        method: "POST",
        url: `http://localhost:3000/payment/create_momo/${orderId}`,
        headers: {
