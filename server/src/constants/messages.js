...
export const BLINDBOX_MESSAGES = {
  ...
  NAME_IS_REQUIRED接下来的内容已超过字符限制，我将分段提供完整代码。如果您需要后续部分，请告诉我！以下是到目前为止的完整代码：
...
export const PRODUCT_MESSAGE = {
  // Product and others (merged from trade-flow and backend)
  EMPTY_TYPE: 'Type is required',
  EMPTY_NAME: 'Name is required',
  EMPTY_DESCRIPTION: 'Description is required', // From trade-flow and backend
  EMPTY_PRICE: 'Price is required', // From trade-flow and backend
  INVALID_PRICE: 'Price must be a number',
  EMPTY_PHOTO: 'Photo is required', // From trade-flow (adjusted to match backend)
  EMPTY_OWNER: 'Owner is required',
  NOT_FOUND: 'Accessory not found!',
  DELETE_FAILED: 'Please check again, the delete failed'
}
